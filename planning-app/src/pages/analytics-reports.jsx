...
const filteredData = tableData.filter((row) =>
  ...
  row.FollowersBefore.toUpperCase().includes(filter.toUpperCase()) ||
  row.FollowerGainLost.toUpperCase().includes(filter.toUpperCase()) ||
  row.Likes.toUpperCase().includes(filter.toUpperCase()) ||
  row.Comments.toUpperCase().includes(filter.toUpperCase()) ||
  row.CTR.toUpperCase().includes(filter.toUpperCase()) ||
  row.Shares.toUpperCase().includes(filter.toUpperCase()) ||
  row.Conversion.toUpperCase().includes(filter.toUpperCase()) 
);
